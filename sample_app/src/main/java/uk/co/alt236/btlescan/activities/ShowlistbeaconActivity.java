...
public class ShowlistbeaconActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent add = new Intent(ShowlistbeaconActivity.this,AddbeaconActivity.class);
                startActivity(add);
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Intent intent = new Intent(ShowlistbeaconActivity.this, ScanBeaconActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent home = new Intent(ShowlistbeaconActivity.this,CategoryActivity.class);
            startActivity(home);
        } else if (id == R.id.nav_about) {

            Intent info = new Intent(ShowlistbeaconActivity.this,ShowInfoActivity.class);
            startActivity(info);
