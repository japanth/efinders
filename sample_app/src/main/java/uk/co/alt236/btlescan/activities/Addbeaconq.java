...
public class Addbeaconq extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addbeaconq);
...
/*
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay = (Button) findViewById(R.id.btn_add_beaconq);
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(status.equals("Objects")){
                    ...
                    Intent tt = new Intent(Addbeaconq.this, ShowlistbeaconActivity.class);
                    startActivity(tt);

                }else if (status.equals("Room")){

                    Intent tt = new Intent(Addbeaconq.this, ShowlistroomActivity.class);
                    startActivity(tt);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent home = new Intent(Addbeaconq.this,CategoryActivity.class);
            startActivity(home);
        } else if (id == R.id.nav_about) {
            Intent info = new Intent(Addbeaconq.this,ShowInfoActivity.class);
            startActivity(info);
        }
